...
![Get admin context of TKG workload cluster](img/tko-on-vsphere/85-ako-workload-3.png)
...
![Check status of AKO and other components](img/tko-on-vsphere/86-ako-workload-4.png)
