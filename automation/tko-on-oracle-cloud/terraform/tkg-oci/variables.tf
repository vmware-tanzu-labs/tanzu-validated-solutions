variable "home_region" {
  description = "Region to use to create global resources"
  type        = string
}
...
variable "controlplane_ingress_cidr" {
  description = "CIDR block for the control plane ingress"
  type        = string
  default     = "0.0.0.0/0"
}
...
variable "create_policies" {
  description = "Create policies for use with instance principals"
  type        = bool
  default     = true
}

variable "create_dynamic_groups" {
  description = "Create dynamic groups used to match instances"
  type        = bool
  default     = false
}

variable "create_tags" {
  description = "Create VMware Tanzu Kubernetes Grid tags"
  type        = bool
  default     = true
}


variable "additional_control_plane_permissions" {
  description = "Additional statements to add to the control plane policy"
  type        = list(string)
  default     = []
}

variable "additional_worker_permissions" {
  description = "Additional statements to add to the control plane policy"
  type        = list(string)
  default     = []
}
...
variable "control_plane_endpoint_subnet_id" {
  description = "Subnet ID for the control plane endpoint when not creating a VCN"
  type        = string
  default     = ""
}
